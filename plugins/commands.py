...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ GROUP ⚡', url='https://t.me/allmovies4uog')
            ],
            [
                InlineKeyboardButton('⚡ MAIN CHANNEL ⚡', url=f"https://t.me/allmovies4uindia"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ MAIN CHANNEL ⚡', url='https://t.me/allmovies4uindia'),
            InlineKeyboardButton('🤖 GROUP 🤖', url='https://t.me/allmovies4uog')
            ],[
